...
servo_angle = [x_min,y_min,z_min,claw_open_angle] # [x, y, z, claw]
...
if write_video:
    ...
    out = cv2.VideoWriter('output.avi', fourcc, 60.0, (800, 800))
...
def landmark_to_servo_angle(hand_landmarks):
    servo_angle = [x_min,y_min,z_min,claw_open_angle]
    WRIST = hand_landmarks.landmark[0]
    ...
    # float to int
    servo_angle = [str(i) for i in servo_angle]
    data = "{},{},{},{}\n".format(servo_angle[0],servo_angle[1],servo_angle[2],servo_angle[3])
    time.sleep(0.015)
        ...
        if results.multi_hand_landmarks:
            if len(results.multi_hand_landmarks) == 1:
                ...
                if servo_angle != prev_servo_angle:
                    ...
                    prev_servo_angle = servo_angle
                    # if not debug:
                    #     arduino.write(bytearray(servo_angle))
            # else:
